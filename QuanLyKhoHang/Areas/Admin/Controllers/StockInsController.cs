    ...
    public class StockInsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            if (!string.IsNullOrEmpty(searchString))
            {
                ...
                stockIns = stockIns.Where(s =>
                    (s.Supplier != null && s.Supplier.Name.ToLower().Contains(keyword)) ||
                    s.StockInDetails.Any(d => d.Product != null && d.Product.Name.ToLower().Contains(keyword))
                );
            }

            return View(await stockIns.OrderByDescending(s => s.Date).ToListAsync());
        }
